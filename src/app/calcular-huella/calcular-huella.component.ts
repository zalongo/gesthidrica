  ...
  calcular() {
    ...
    const totales = {
      ...
      fosfatoTotal:
        ...
        Number(
          (
            (this.salidaAguaConsumidaTotal * this.fosfato3Promedio) /
            1000
          ).toFixed(6)
        ),
      demandaBioOxgTotal: Number(
        ((this.salidaAguaDescargadaTotal * this.dbo1Promedio) / 1000).toFixed(6)
      ),
      arsenicoTotal:
        Number(
          (
      ...
      availableWaterRemainingAwareTotal: Number(
        (this.salidaAguaConsumidaTotal * 80.095291).toFixed(6)
      ),
      toxixidadHumanaTotal: Number(
        (toxixidadHumana1 + toxixidadHumana2).toFixed(6)
      ),
      ...
      potencialesImpactosSaludTotal: Number(
        (this.salidaAguaConsumidaTotal * 0.000017256729214146).toFixed(6)
      ),
      enfermedadesPorToxicidadTotal: Number(
        (enfermedadesPorToxicidad1 + enfermedadesPorToxicidad2).toFixed(6)
      ),
      disminucionBiodiversidadTerrestreTotal: Number(
        (this.salidaAguaConsumidaTotal * 0.266051).toFixed(6)
      ),
      ecosistemasAcuaticosAfectadosPorEcotoxicidadTotal: Number(
        (
          ecosistemasAcuaticosAfectadosPorEcotoxicidad1 +
          ecosistemasAcuaticosAfectadosPorEcotoxicidad2
        ).toFixed(6)
      ),
      ecosistemasAcuaticosAfectadosPorEutrofizacionTotal: Number(
        (
    ...
    const dataLista = {
      ...
      entrasdaDeAgua: [
        ...
        },
        {
          ...
          porcentaje:
            (this.aguaSuperficialTotal / this.aguaSuperficialTotal) * 100,
        },
      ],
      salidasDeAgua: [
        {
          ...
          toxixidadHumanaProcentaje: (
            (toxixidadHumana1 / totales.toxixidadHumanaTotal) *
            100
          ).toFixed(1),
          ecotoxixidad: ecotoxixidad1.toFixed(6),
          ecotoxixidadPorcentaje: (
            (ecotoxixidad1 / totales.ecotoxixidadTotal) *
            100
          ).toFixed(1),
          eutrofizacion: eutrofizacion1.toFixed(6),
          eutrofizacionPorcentahe: (
            (eutrofizacion1 / totales.eutrofizacionTotal) *
            100
          ).toFixed(1),
          enfermedadesPorToxicidad: enfermedadesPorToxicidad1.toFixed(6),
          enfermedadesPorToxicidadPorcentaje: (
            (enfermedadesPorToxicidad1 /
              totales.enfermedadesPorToxicidadTotal) *
            100
          ).toFixed(1),
        ...
        },
        {
          ...
          toxixidadHumanaProcentaje: (
            (toxixidadHumana2 / totales.toxixidadHumanaTotal) *
            100
          ).toFixed(1),
          ecotoxixidad: ecotoxixidad2.toFixed(6),
          ecotoxixidadPorcentaje: (
            (ecotoxixidad2 / totales.ecotoxixidadTotal) *
            100
          ).toFixed(1),
          eutrofizacion: eutrofizacion2.toFixed(6),
          eutrofizacionPorcentahe: (
            (eutrofizacion2 / totales.eutrofizacionTotal) *
            100
          ).toFixed(1),
          enfermedadesPorToxicidad: enfermedadesPorToxicidad2.toFixed(6),
          enfermedadesPorToxicidadPorcentaje: (
            (enfermedadesPorToxicidad2 /
              totales.enfermedadesPorToxicidadTotal) *
            100
          ).toFixed(1),
          ecosistemasAcuaticosAfectadosPorEcotoxicidad:
          ...
          porcentaje:
            (this.salidaAguaInfiltradaTotal / this.salidaAguaInfiltradaTotal) *
            100,
          availableWaterRemainingAwarePorcentaje: 0,
          potencialesImpactosSaludPorcentaje: 0,
          disminucionBiodiversidadTerrestreTotal: 0,
        ...
        },
        {
          ...
          availableWaterRemainingAwarePorcentaje: (
            ((this.salidaAguaConsumidaTotal * 80.095291) /
              totales.availableWaterRemainingAwareTotal) *
            100
          ).toFixed(1),
          ...
          porcentaje:
            (this.salidaAguaConsumidaTotal / this.salidaAguaConsumidaTotal) *
            100,
